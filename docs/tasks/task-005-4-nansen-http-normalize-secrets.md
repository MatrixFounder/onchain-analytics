...
| **Источники**           | [system-architecture.md](../architectures/system-architecture.md) §3.2 «Десятый адаптер»/«429»/«Частичный отказ», [data-model.md](../architectures/data-model.md) §4.1 |
