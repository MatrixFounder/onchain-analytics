...
- **L-12** [Blockscout facade does not answer token.holders on base within 30s; ethereum is marginal at our 5s ceiling](issues/l-12-blockscout-facade-does-not-answer-token-holders-on-base-within-30s-ethereum-is-marginal-at-our-5s-ceiling.md) — severity `SEV-3`, status `open`, opened 2026-08-11
