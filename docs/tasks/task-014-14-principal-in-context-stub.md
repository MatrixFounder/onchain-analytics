...
Сегодня `toolSpecs` содержит 20 записей. Задача 014-32b добавляет `onchain_pool_info`, задача 014-32c — `onchain_token_pools`, после чего их 22. Тест обходит реестр, число тулов в нём не зашито.
