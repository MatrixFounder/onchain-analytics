...
- `docs/architectures/data-model-entities.md:143` — `` `null` = the vendor does not have the chain ``
- `docs/architectures/data-model-entities.md:197` — `the absence of a probe means **`unverified`, not `unsupported`**`
