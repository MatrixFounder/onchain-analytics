...
- **RF-9** [The eval reports a transport timeout as rate-limited and names an unrelated knob](issues/rf-9-the-eval-reports-a-transport-timeout-as-rate-limited-and-names-an-unrelated-knob.md) — severity `SEV-3`, status `open`, opened 2026-08-11
